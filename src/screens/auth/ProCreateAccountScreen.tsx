...
type Props = {
  navigation: NativeStackNavigationProp<AuthStackParamList, 'ProCreateAccount'>;
};

export const ProCreateAccountScreen: React.FC<Props> = ({ navigation }) => {
  const { signUpBarber, signIn } = useAuth();
  ...
  const handleCreate = async () => {
    ...
    setLoading(true);
    try {
      await signUpBarber(email.trim(), password, phone.trim());
      // Navigator will automatically route to ProOnboardingStack
    } catch (err: any) {
